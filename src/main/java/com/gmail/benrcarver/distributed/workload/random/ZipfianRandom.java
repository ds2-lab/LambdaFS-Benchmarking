 ...
 */
public class ZipfianRandom extends NumberRandom {
   ...
   */
  public ZipfianRandom(long items) {
    this(0, items - 1);
  }
   ...
   */
  public ZipfianRandom(long min, long max) {
   ...
   */
  public ZipfianRandom(long items, double zipfianconstant) {
   ...
   * @param zipfianconstant The zipfian constant to use.
   */
  public ZipfianRandom(long min, long max, double zipfianconstant) {
   ...
   */
  public ZipfianRandom(long min, long max, double zipfianconstant, double zetan) {
  ...
  public static void main(String[] args) {
    new ZipfianRandom(ScrambledZipfianRandom.ITEM_COUNT);
  }
  ...
  @Override
  public double mean() {
    throw new UnsupportedOperationException("@todo implement ZipfianRandom.mean()");
  }
}