 ...
 */
public class UniformRandom extends Random<String> {
  private final List<String> values;
  private String laststring;
  private final UniformLongRandom gen;

  /**
   * Creates a generator that will return strings from the specified set uniformly randomly.
   */
  public UniformRandom(Collection<String> values) {
    this.values = new ArrayList<>(values);
    laststring = null;
    gen = new UniformLongRandom(0, values.size() - 1);
  }
